...
- Il y avait 3 grands écrans rectangulaire

- Il y avait trois écrans plus petits 

- Il y avait des pairs d'écouteurs

 ## Type d'installation:
 - Installation vidéo sur plusieurs écrans.

 - Installation interactive liée à l’intelligence artificielle.

 - Installation sonore avec voix synthétiques générées par IA.
